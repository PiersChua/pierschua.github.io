...
export const projects: Project[] = [
  ...
  },
  {
    ...
    startDate: "Apr 2023",
    endDate: "Sep 2023",
    cardDesc: "Food ordering Application",
    modalDescs: [
  ...
  },
  {
    ...
    startDate: "Apr 2026",
    endDate: "Apr 2026",
    cardDesc: "AI-powered Talent Matching platform for fairer hiring",
    modalDescs: [
      "Built a full-stack hiring platform that helps candidates access opportunities through merit-based evaluation",
      "Designed anonymous candidate profiling so hirers can assess applicants based on skills, experience, and interview performance",
      "Implemented an AI voice interview workflow where spoken responses are evaluated to filter top performing candidates efficiently",
    ],
    problemStatement:
      "Access to internships, mentorships, projects, and jobs is disproportionately shaped by network proximity, school brand, and insider access — not raw capability. Capable candidates from under-resourced backgrounds are systematically filtered out before employers ever see them. Aptly redesigns opportunity discovery so that access is driven strictly based on individual's capability rather than popularity.",
    ...
    projectUrl: "https://devpost.com/software/aptly-x9bm0w",
    type: "Hackathon",
    skills: ["Next.js", "TypeScript", "PostgreSQL", "OpenAI", "ElevenLabs"],
  },
  {
    id: 11,
    title: "EC Draft",
    startDate: "Jun 2026",
    endDate: "Aug 2026",
    cardDesc: "Automated Probate Case Document Drafter for Eunice Chua Law LLC",
    modalDescs: [
      "Built a probate platform that generates multiple court-ready documents from one structured case file",
      "Hosted on SOC 2 Type II and ISO 27001 certified infrastructure, with RBAC, administrator-gated account provisioning, and automatic session revocation on credential changes",
      "Efficiently cut case drafting duration by up to 90%",
    ],
    problemStatement:
      "Probate applications require a stack of court documents such as oaths and affidavits that restate the same names, identifiers, and dates in subtly different legal language. Drafting them manually is a slow and error-prone process. EC Draft bypasses this by capturing each case once and generates the full document set from the firm's own precedents, applying the correct wording, pronouns, and party lists automatically.",
    cardImage: "./project_thumbnail_11.png",
    modalImages: ["project_11_1.webp", "project_11_2.webp"],
    type: "Client Project",
    skills: ["Next.js", "TypeScript", "PostgreSQL", "Vercel", "Resend"],
  },
];
