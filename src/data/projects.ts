...
export const projects: Project[] = [
  ...
  },
  {
    ...
    type: "Template",
    skills: ["Next.js", "TypeScript", "Netlify", "Cloudflare"],
  },
  {
    id: 11,
    title: "AutoPro",
    ...
    modalDescs: [
      ...
      "Integrated a Gemini-powered chatbot to assist in FAQs and clients' enquires",
    ],
    ...
    type: "Template",
    skills: ["Next.js", "TypeScript", "Netlify", "Gemini"],
  },
  {
    id: 12,
    title: "OhMyNails SG",
    startDate: "Feb 2026",
    endDate: "Mar 2026",
    cardDesc: "Home-Based Nail Salon website",
    modalDescs: [
      "Designed a portfolio website to showcase nail art portfolio",
      "Built a smooth enquiry flow with WhatsApp API integration for convenient customer support",
      "Optimized the website for mobile users, ensuring a seamless browsing experience across devices",
    ],
    cardImage: "./project_thumbnail_12.png",
    webUrl: "https://piers-template-ohmynails.netlify.app/",
    modalImages: [
      "./project_12_1.webp",
      "./project_12_2.webp",
      "./project_12_3.webp",
    ...
    type: "Client Project",
    skills: ["Next.js", "TypeScript", "Netlify"],
  },
  {
    id: 13,
    title: "Aptly",
    ...
    cardImage: "./project_thumbnail_13.png",
    modalImages: [
      "project_13_1.webp",
      "project_13_2.webp",
      "project_13_3.webp",
    ],
    webUrl: "https://devpost.com/software/aptly-x9bm0w",
    type: "Hackathon",
